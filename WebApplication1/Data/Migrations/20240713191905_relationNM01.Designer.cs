...
namespace WebApplication1.Data.Migrations
{
    ...
    [Migration("20240713191905_relationNM01")]
    partial class relationNM01
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Grupo_de_ViagemViagem", b =>
                {
                    b.Property<int>("GruposID_do_Grupo")
                        .HasColumnType("int");

                    b.Property<int>("ViagensID_da_Viagem")
                        .HasColumnType("int");

                    b.HasKey("GruposID_do_Grupo", "ViagensID_da_Viagem");

                    b.HasIndex("ViagensID_da_Viagem");

                    b.ToTable("Grupo_de_ViagemViagem");
                });
            ...
            modelBuilder.Entity("WebApplication1.Models.ViagemGrupo", b =>
                {
                    b.Property<int>("ViagemId")
                        .HasColumnType("int");

                    b.Property<int>("GrupoDeViagemId")
                        .HasColumnType("int");

                    b.HasKey("ViagemId", "GrupoDeViagemId");

                    b.HasIndex("GrupoDeViagemId");

                    b.ToTable("ViagemGrupos");
                });
            ...
            modelBuilder.Entity("Grupo_de_ViagemViagem", b =>
                {
                    b.HasOne("WebApplication1.Models.Grupo_de_Viagem", null)
                        .WithMany()
                        .HasForeignKey("GruposID_do_Grupo")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebApplication1.Models.Viagem", null)
                        .WithMany()
                        .HasForeignKey("ViagensID_da_Viagem")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("WebApplication1.Models.ViagemGrupo", b =>
                {
                    b.HasOne("WebApplication1.Models.Grupo_de_Viagem", "GrupoDeViagem")
                        .WithMany("ViagemGrupos")
                        .HasForeignKey("GrupoDeViagemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
