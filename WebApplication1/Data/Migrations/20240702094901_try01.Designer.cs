...
namespace WebApplication1.Data.Migrations
{
    ...
    [Migration("20240702094901_try01")]
    partial class try01
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Grupo_de_ViagemUser", b =>
                {
                    ...
                    b.HasKey("GruposID_do_Grupo", "UsersID_do_User");

                    b.HasIndex("UsersID_do_User");

                    b.ToTable("GrupoUser", (string)null);
                });
            ...
            modelBuilder.Entity("WebApplication1.Models.Viagem", b =>
                {
                    ...
                    b.HasIndex("ID_do_Grupo_de_Viagem");
            ...
            modelBuilder.Entity("WebApplication1.Models.Viagem", b =>
                {
                    b.HasOne("WebApplication1.Models.Grupo_de_Viagem", "Grupo")
                        .WithMany("Viagens")
                        .HasForeignKey("ID_do_Grupo_de_Viagem")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
